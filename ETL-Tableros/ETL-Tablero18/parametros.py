...
tableros_mintic_control = "dev-tableros18_mintic_control"
####################################
##Service manager
sm_interaciones = 'servicemanager-interacciones-tmp'
sm_incidentes = 'servicemanager-incidentes-tmp'
