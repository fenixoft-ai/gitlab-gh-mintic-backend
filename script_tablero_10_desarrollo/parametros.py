...
usuarios_mintic_concat_index_tablero10 = "usuarios-mintic-concat-tablero10"
trafico_mintic_concat_index = "trafico-mintic-concat"
gestion_mintic_concat_index = "gestion-mintic-concat"
#control de ejecucion
mintic_control = 'usuarios-dev-control_ejecucion_mintic'
usuarios_mintic_control = 'usuarios-dev-control_ejecucion_mintic'
####################################
##Service manager
sm_interaciones = 'servicemanager-interacciones'
sm_incidentes = 'servicemanager-incidentes'
sm_paradas = 'servicemanager-reloj'